package com.example.mannig.utils
...
object Constants{
    ...
    const val TASKLISTITEMPOSITION : String = "task_list_item_position"
    const val CARD_LIST_ITEM_POSOTION:String="card_list_item_position"
    const val READ_STORAGE_PERMISSION_CODE = 1
    const val PICK_IMAGE_REQUEST_CODE = 2
    const val DOCUMENT_ID :String = "documentId"
    const val SELECT: String = "Select"
    const val UN_SELECT: String = "UnSelect"
    const val BOARD_MEMEBERS_LIST:String = "board_members_list"
    ...
    const val PROGEMANAG_PREFERENCES: String = "ProjemanagPrefs"
     ...
     fun showiamgechosser(activity: Activity) {
