...
open class memberslistitemadapter(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is MyViewHolder) {
            ...
            Glide
                ...
                .into(holder.ivmemimg)

            holder.membername.text = model.name
            holder.memberemail.text = model.email

            if (model.selected) {
                holder.iselectedmember.visibility = View.VISIBLE
            } else {
                holder.iselectedmember.visibility = View.GONE
            }
    ...
    inner class MyViewHolder(view: View) : RecyclerView.ViewHolder(view){
        val ivmemimg: CircleImageView = view.findViewById(R.id.iv_member_image)
        val iselectedmember: ImageView = view.findViewById(R.id.iv_selected_member)
